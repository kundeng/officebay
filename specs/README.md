...
| [02-notebook-baseline](02-notebook-baseline/spec.md) | DRAFT | Baseline inherited behavior, source-adaptation experiments and UI review |
...
| [09-notebook-revisions](09-notebook-revisions/spec.md) | DRAFT | Aggregate/note history, timed replay, restore and conflict recovery |
...
Implementation follows the [editor adaptation map](../docs/design/editor-adaptation.md); MDLayers has no implemented core yet. The [replay contract](../docs/design/replay.md) separates durable snapshots from timed action capture. Review the [UI study](../prototypes/notebook-ui/README.md) and [Claude request](../docs/design/claude-ui-design-request.md) during baseline, then implement approved interactions in the owning sprint.
