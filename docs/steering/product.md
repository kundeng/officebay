...
The reusable document/page/mark core is MDLayers. OfficeBay, VS Code and Obsidian consume one implementation with host-specific adapters. Their authored file contracts, identities and coordinate semantics agree.
...
- Support durable, inspectable revisions independently of undo/redo and chat history. Excalidraw remains the file-format choice.
